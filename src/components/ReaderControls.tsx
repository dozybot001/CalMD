...
export default function ReaderControls({
  ...
  return (
    ...
    >
      ...
      >
        <span className="control-surface__brand">CALMD</span>
      ...
      >
        <div className="control-surface__panel-body">
          ...
          <div className="control-surface__controls">
            ...
            <button
              className="button button--pill"
              disabled={viewMode !== "preview" || isLongImageExporting}
              title={
                viewMode === "preview"
                  ? "将当前阅读版面导出为长图"
                  : "长图导出仅支持阅读视图"
